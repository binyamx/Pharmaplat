...
import com.example.pharmaplat.LoginSignup.VerifyOTP
import com.example.pharmaplat.R
import com.example.pharmaplat.PagerAdapter.WelcomePagerAdapter
...
class WelcomeActivity : AppCompatActivity() {
    ...
    private lateinit var welcomeViewPager: ViewPager2
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        welcomeTabLayout = findViewById(R.id.welcome_tab_layout)
        welcomeViewPager = findViewById(R.id.welcome_view_pager)

        val welcomePagerAdapter = WelcomePagerAdapter(this)
        welcomeViewPager.adapter = welcomePagerAdapter

        TabLayoutMediator(welcomeTabLayout, welcomeViewPager) { tab, position ->
